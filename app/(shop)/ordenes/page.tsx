...
export default async function OrdersPage() {
    ...
    <main className="min-h-screen pt-32 pb-20 bg-[#FDFCFB] dark:bg-[#050505] transition-colors">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="space-y-6">
          {orders.length === 0 ? (
            <div className="p-12 border border-dashed border-zinc-200 dark:border-zinc-800 rounded-2xl text-center">
            ...
            orders.map((order) => (
              <div
                key={order.id}
                className="bg-white dark:bg-[#111] border border-zinc-100 dark:border-zinc-800 rounded-2xl overflow-hidden shadow-sm"
              >
                {/* Header de la orden */}
  ...
  */}
                          <div className="absolute inset-0 flex items-center justify-center text-[10px] text-zinc-400 font-bold">
