    ...
    <div className="w-full max-w-md mx-auto rounded-3xl bg-white dark:bg-zinc-950 shadow border border-zinc-100 dark:border-zinc-800 overflow-hidden transition-all duration-300">
      <div className="p-8 sm:p-8">
        ...
        <button
          ...
          className="flex h-12 w-full items-center justify-center gap-3 rounded-full border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 text-sm font-bold text-zinc-700 dark:text-zinc-200 hover:bg-zinc-50 dark:hover:bg-zinc-800 transition-all shadow-sm hover:shadow active:scale-[0.98]"
