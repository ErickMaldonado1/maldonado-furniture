    ...
    <main className="min-h-screen pt-28 pb-20 bg-zinc-50 dark:bg-[#050505] transition-colors">
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        <header className="mb-12">
          <Link
            href="/"
            className="flex items-center gap-2 text-[10px] font-black uppercase -[0.2em] text-zinc-400 hover:text-[#4A3728] transition-colors mb-6 w-fit"
          >
            <ArrowLeft size={14} />
            Volver a la tienda
          </Link>
          <h1 className="text-4xl md:text-5xl font-black uppercase  text-zinc-900 dark:text-white">
        ...
        <div className="space-y-8">
          {orders.length === 0 ? (
            <div className="py-24 text-center bg-white dark:bg-zinc-900 rounded-[2.5rem] border border-zinc-100 dark:border-zinc-800 shadow-sm">
              ...
              />
              <p className="text-[10px] uppercase  text-zinc-400 dark:text-zinc-600 font-black italic">
              ...
              >
                <div className="px-8 py-6 bg-zinc-50/50 dark:bg-white/2 flex flex-wrap items-center justify-between gap-6 border-b border-zinc-50 dark:border-zinc-800">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="text-[10px] font-black uppercase -[0.2em] text-[#4A3728]">
