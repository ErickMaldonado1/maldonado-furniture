  ...
  return (
    <main className="mt-20 min-h-screen bg-white dark:bg-[#050505] transition-colors duration-300">
      <section className="pt-8 md:pt-14 pb-8 max-w-360 mx-auto px-4 sm:px-6">
        <div className="flex flex-col md:flex-row justify-between items-center md:items-end gap-10 border-b border-zinc-100 dark:border-zinc-800/50 pb-6 mb-6 md:mb-10">
          <motion.div
          ...
          >
            <div className="relative border-l-2 border-[#4A3728] pl-6 py-1">
              <p className="text-sm md:text-base lg:text-lg font-medium text-zinc-500 dark:text-zinc-400 leading text-left">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-px bg-zinc-100 dark:bg-zinc-800 border border-zinc-100 dark:border-zinc-800">
            ...
            >
              <div>
                ...
                <h4 className="text-lg font-black uppercase  text-zinc-900 dark:text-white mb-4">
                  Escríbenos
                </h4>
            ...
            <div className="flex flex-col justify-between p-10 bg-white dark:bg-[#050505] min-h-75">
              ...
              <span className="flex items-center gap-2 text-[14px] font-black  text-[#4A3728] mt-4">
      ...
      <section className="py-8 md:py-14 max-w-360 mx-auto px-4 sm:px-6">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-stretch">
          <div className="flex flex-col h-full order-2 lg:order-1">
            <div className="mb-6 md:mb-10 border-b border-zinc-100 dark:border-zinc-800/50 pb-6">
              ...
              <p className="text-sm text-zinc-400 uppercase mt-2">
