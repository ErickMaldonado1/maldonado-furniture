...
const ProcessStep = ({
  ...
  >
    ...
    <h3 className="text-lg md:text-xl font-medium  text-zinc-900 dark:text-white mb-2 relative z-10">
      {title}
    </h3>
      ...
      <section className="py-24 px-6 md:px-8 max-w-5xl mx-auto text-center">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            ...
            >
              <h3 className="text-lg md:text-xl font-medium  text-zinc-900 dark:text-white mb-3">
                {feature.title}
              </h3>
