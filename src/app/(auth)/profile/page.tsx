  ...
  return (
    <main className="min-h-screen pt-28 pb-20 bg-zinc-50 dark:bg-[#050505] transition-colors">
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        <Link
          href="/"
          className="inline-flex items-center gap-2 text-[10px] font-black uppercase -[0.2em] text-zinc-400 hover:text-[#4A3728] dark:hover:text-[#D4A373] transition-colors mb-10 w-fit"
        >
          <ArrowLeft size={14} />
          Volver a la tienda
        </Link>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-white dark:bg-zinc-900 rounded-[2rem] border border-zinc-100 dark:border-zinc-800 shadow-sm overflow-hidden">
            <div className="px-8 pt-7 pb-4 border-b border-zinc-50 dark:border-zinc-800">
              <h2 className="text-[12px] font-black uppercase -[0.2em] text-[#A6866A] dark:text-[#D4A373] flex items-center gap-2">
                <User size={14} />
                Datos de la Cuenta
              </h2>
            </div>
              ...
              {user.orders.map((order) => (
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="text-xs font-black text-zinc-900 dark:text-white uppercase -wider">
