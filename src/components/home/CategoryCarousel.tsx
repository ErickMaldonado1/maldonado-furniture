...
export default function CategoryCarousel({
  ...
  return (
    <section className="py-8 md:py-14 bg-white dark:bg-[#050505] transition-colors duration-500 overflow-hidden">
      <div className="max-w-360 mx-auto px-4 sm:px-6 text-center sm:text-left">
        <div className="flex items-center justify-between mb-6 md:mb-10 border-b border-zinc-100 dark:border-zinc-800/50 pb-6">
          ...
          >
            ...
            <span className="sm:hidden mt-0.5">COLECCIÓN</span>
            <ArrowRight className="w-4 h-4 sm:w-5 sm:h-5 text-[#4A3728] group-hover:translate-x-1 transition-transform" />
          </Link>
        </div>
