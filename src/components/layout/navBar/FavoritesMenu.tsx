                ...
                <div className="flex-1 flex flex-col justify-between py-1">
                  <div>
                    <Link
                      ...
                      onClick={onClose}
                    >
                      <h3 className="text-base font-bold text-zinc-900 dark:text-white leading hover:underline">
                        {item.name}
                      </h3>
                    </Link>
                  ...
                  <button
                    ...
                    className="text-xs font-bold uppercase -wider text-zinc-900 dark:text-white border-b border-zinc-200 dark:border-zinc-800 self-start hover:border-[#4A3728] transition-colors"
                    aria-label="add-cart"
                  >
                    Añadir al Carrito
                  </button>
