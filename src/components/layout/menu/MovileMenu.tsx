...
import { HiOutlineX, HiOutlineMail, HiOutlinePhone } from "react-icons/hi";
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto overscroll-contain">
          <div className="px-4 py-4 space-y-6">
            ...
            <div>
              <p className="text-[12px] font-black uppercase -[0.2em] text-zinc-400 dark:text-zinc-500 mb-3">
                Categorías
              </p>
                ...
                {categories.map((cat) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        <span className="text-[15px] font-bold text-zinc-800 dark:text-zinc-200">
                          {cat.label}
                        </span>
                        <ChevronRight
                          width={20}
                      ...
                      >
                        {cat.subcategories.map((sub) => (
                          <Link
                            ...
                            href={sub.href}
                            onClick={onClose}
                            className="px-6 py-2.5 text-[15px] font-medium text-zinc-600 dark:text-zinc-400 active:bg-zinc-50 dark:active:bg-zinc-900/50 transition-colors"
                          >
                            {sub.label}
                          </Link>
                        ))}
            ...
            <div>
              <p className="text-[12px] font-black uppercase -[0.2em] text-zinc-400 dark:text-zinc-500 mb-4">
                Menú
              </p>
        ...
        <div className="px-6 py-6 bg-zinc-50 dark:bg-[#0d0d0d] border-t border-zinc-100 dark:border-zinc-800">
          <div className="flex flex-col gap-5">
            ...
            <div className="space-y-3 text-[14px] font-bold text-zinc-500 dark:text-zinc-400  mt-4">
              <p className="flex items-center gap-3">
                <HiOutlineMail size={20} className="text-zinc-400" />{" "}
                mueblesmaldonadoec@gmail.com
              </p>
              <p className="flex items-center gap-3">
                <HiOutlinePhone size={20} className="text-zinc-400" /> +593 95
                950 4842
              </p>
            </div>
          </div>
