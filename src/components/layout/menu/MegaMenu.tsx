            ...
            <div className="mx-auto max-w-7xl">
              <div className="grid grid-cols-[1.2fr_3fr_1.8fr] gap-10 px-8 py-8">
                ...
                <div className="min-w-0">
                  <p className="text-[12px] font-bold uppercase -[0.25em] text-zinc-400 dark:text-zinc-500 mb-5">
                    {data.label}
                  </p>
                    ...
                    {data.subcategories.slice(0, 6).map((sub: any) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <span
                            className={`text-[12px] font-bold uppercase -wider transition-colors duration-300 ${isHovered ? "text-[#4A3728] dark:text-white" : "text-zinc-600 dark:text-zinc-400"}`}
                          >
                            {sub.label}
                          </span>
                        </Link>
                    ...
                    {data.featuredContent.slice(0, 2).map((item: any) => (
                      ...
                      >
                        ...
                        <div className="p-4 flex flex-col justify-between flex-1">
                          <div>
                            <h4 className="text-xs font-bold uppercase -wider text-zinc-900 dark:text-white leading mb-1 group-hover:text-[#4A3728] dark:group-hover:text-white transition-colors">
                              {item.title}
                            </h4>
